...
struct RatingCircle_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            RARatingCircle(score: 80)
            RARatingCircle(score: 10)
            RARatingCircle(score: 30)
            RARatingCircle(score: 50)
        }
    }
}
